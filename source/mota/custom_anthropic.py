"""
custom_anthropic.py - Anthropic API 调用模块

本模块提供了用于调用 Anthropic API 的实现类，实现了自定义接口。
用户可以根据 Anthropic API 官方文档调整请求逻辑。
该模块实现了与 Anthropic API 的标准交互，支持系统提示词和用户消息的分离。
"""
